 ...
 * Purpose: Store contracts and templates for contract generation
 */

error_reporting(E_ALL);
ini_set('display_errors', 1);

echo "=== Migration: Create Contract Management Tables ===\n\n";
...
if ($result->num_rows > 0) {
    echo "✓ Table 'contratos' already exists. Skipping creation.\n";
} else {
    ...
    if ($conexion->query($sql_contratos)) {
        echo "✓ Table 'contratos' created successfully.\n";
    } else {
        die("✗ Error creating contratos table: " . $conexion->error . "\n");
    }
}
...
if ($result->num_rows > 0) {
    echo "✓ Table 'plantillas_contrato' already exists. Skipping creation.\n";
} else {
    ...
    if ($conexion->query($sql_plantillas)) {
        echo "✓ Table 'plantillas_contrato' created successfully.\n";
    } else {
        die("✗ Error creating plantillas_contrato table: " . $conexion->error . "\n");
    }
...
";
    ...
    if ($stmt->execute()) {
        echo "✓ Default template inserted successfully.\n";
    } else {
        echo "✗ Warning: Could not insert default template: " . $stmt->error . "\n";
    }
    $stmt->close();
}
